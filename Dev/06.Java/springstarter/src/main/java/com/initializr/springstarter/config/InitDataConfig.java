...
@Component      // Spring 컴포넌트로 등록 - 자동으로 빈 생성 (초기 데이터 설정)
public class InitDataConfig implements CommandLineRunner {  //애플리케이션 시작 시 실행되는 인터페이스
    @Autowired  // BookService 의존성 자동 주입
    private BookService bookService;

    @Override
    public void run(String... args) throws Exception { //애플리케이션 시작 후 자동 실행되는 메서드
