...
public class CustomerController {
    ...
    @GetMapping("/query-method/query-method")
    @ResponseBody
    ...
    public String queryMethodMenu() {
        return """
                ...
                <body>
                    ...
                    <div class="test-list">
                        <div class="test-item">
                            <a href="/customer/query-method/2">2. findByUsernameAndPassword</a> - 로그인 체크
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/3">2-3. findByCustomerNameOrOccupation</a> - OR 조건
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/4">2-4. findByAgeGreaterThan</a> - 비교 연산자 - Greater Than (초과)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/5">2-5. findByAgeLessThanEqual</a> - 비교 연산자 - Less Than Equal (이하)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/6">2-6. findByAgeBetween</a> - Between - 범위 검색
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/7">2-7. findByCustomerNameContaining</a> - Like 검색 - Containing (포함)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/8">2-8. findByUsernameStartingWith</a> - Like 검색 - Containing (포함)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/9">2-9. findByRatingOrderByAgeDesc</a> - Like 검색 - Containing (포함)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/10">2-10. findByAgeBetweenAndRatingOrderByReservesDesc</a> - Like 검색 - Containing (포함)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/11">2-11. findByDeletedFalse</a> - Like 검색 - Containing (포함)
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/12">2-12. countByRating</a> - 카운트
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/13">2-13. existByUsername</a> - 존재 확인
                        </div>
                        <div class="test-item">
                            <a href="/customer/query-method/14">2-14. findTop5ByOrderByReservesDesc</a> - 서브쿼리 JPQL
                        </div>
                    </div>
                </body>
                </html>
    ...
    public String runQueryMethods(@PathVariable int testNumber) {
        switch (testNumber) {
            ...
            default -> {
                return "❌ 잘못된 테스트 번호입니다.(2- 사이의 숫자를 입력하세요.)";
            }
        }
    ...
    public String runJPQLTest(@PathVariable int testNumber) {
        switch (testNumber) {
            ...
            case 2 -> customerService.jpqlTest2FindPlatinumCustomerInAgeRange();
        ...
        return """
                ...
                <body>
                    ...
                    <div class="test-list">
                        ...
                        <div class="test-item">
                            <a href="/customer/jpql/2">3-2. findPlatinumCustomerInAgeRange</a> - 복잡한 조건 JPQL
                        </div>
                        <div class="test-item">
                            <a href="/customer/jpql/3">3-3. getCustomerStaticsByRating</a> - 집계 함수 JPQL
                        </div>
                        <div class="test-item">
                            <a href="/customer/jpql/4">3-4. findCustomersAboveAverageReserves</a> - 집계 함수 JPQL
                        </div>
                    </div>
                </body>
                </html>
