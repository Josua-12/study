...
public class TimeCalculator {
	...
	public static void main(String[] args) {
		...
		System.out.println("시급: " + hourlyRate + "원");
		System.out.println();
		...
		System.out.println("일급: " + DaliyRate + "원");
		int MonthlyRate = DaliyRate * monthlyWorkoutDay;
		System.out.println("월급: " + MonthlyRate + "원");
		System.out.println();
		
		System.out.println("--- 추가 정보 ---");
		int YearlyWorkoutTime = MonthlyWorkoutTime * 12;
		System.out.println("연간 총 근무시간: " + YearlyWorkoutTime + "시간");
		int salary = MonthlyRate * 12;
		System.out.println("연봉: " + salary + "원");
		int daytime = 60 * 60 * 24;
		System.out.println("하루는 총 " + daytime + "초입니다.");
		int weekminute = 7 * 24 * 60;
		System.out.println("일주일은 총 " + weekminute + "분입니다.");
	}
}
