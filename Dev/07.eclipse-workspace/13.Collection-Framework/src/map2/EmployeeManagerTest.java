...
public class EmployeeManagerTest {
	...
	private static void findEmployee(EmployeeManager manager) {
		...
		System.out.println("존재하지 않는 사원 검색 결과 : " + (notFound == null ? "직원을 찾을 수 없습니다." : 
							notFound));
	...
	private static void addEmployees(EmployeeManager manager) {
		...
		// 다양한 부서의 직원들 추가
		Employee emp1 = new Employee("emp001", "이방원", "개발팀", "주임", 45000000, "Leebw@gmail.com");
		...
		Employee emp4 = new Employee("emp004", "손흥민", "인사팀", "과정", 60000000, "Son@gmail.com");
